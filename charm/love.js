...
$(".download-button").on("click", function(){
 ...
 $(".parent p").html("your love life is scored " + loveScore + "%" + " you both love each other but you're also letting your ego and pride get's in the way.");
}

setTimeout(function(){ 
  $(".parent img").attr("src","images/myGee12.png" );
  $(".colored-section").css("background-color","#E90064"); 
